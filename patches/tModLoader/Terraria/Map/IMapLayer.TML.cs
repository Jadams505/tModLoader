...
public partial interface IMapLayer
{
	...
	public static IMapLayer DeathMarkers { get; private set; } = new DeathMarkersMapLayer();
	public static IMapLayer PlayerHeads { get; private set; } = new PlayerHeadsMapLayer();
